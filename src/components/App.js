        ...
        <div className='form'>
          <form action=''>
            <fieldset className='design js__design-fieldset'>
              ...
              <div className='design__colors js__design-colors collapsed'>
            ...
            <fieldset className='fill'>
              ...
              <div className='js__field js__inputs field collapsed'>
            ...
            <fieldset className='share'>
              ...
              <article className='js__share share__article collapsed'>
